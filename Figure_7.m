% MATLAB code for generating Figure 7 of the manuscript
% Different plots of probability density functions can be generated by
% changing the values of sigg in Line 16 of the code
clc
clear
close all
warning off
...
mu = 2; k = 5; epsi = 1.5;
%
% sigg = 0.01 corresponds to Figure 7(a) of the manuscript
% sigg = 0.5 corresponds to Figure 7(b) of the manuscript
% sigg = 1 corresponds to Figure 7(c) of the manuscript
sigg = 0.01;
...
%
  ...
  %
    ...
    L1L1b = L1L1bv(var);
%
% Simulation using g-Weak 3.0 scheme
...
title(sprintf('$\\sigma = %.2f$' , sigg),'FontName','Times New Roman','FontSize',20,'FontWeight','bold','Interpreter','latex');
%
% End